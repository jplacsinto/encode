...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <h5 class="card-title border-bottom pb-3">User: {{$user->name}}</h5>
        <div class="row">
            <div class="col-sm">
                <form action="{{route('users.update', $user)}}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input @if($user->active) checked @endif name="active" value="1" type="checkbox" class="custom-control-input" id="active" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-switch my-2">
                                <input name="roles[]" value="{{ $role->id }}" type="checkbox" class="custom-control-input" id="customSwitch{{$role->id}}" @if($user->roles->pluck('id')->contains($role->id)) checked @endif />
